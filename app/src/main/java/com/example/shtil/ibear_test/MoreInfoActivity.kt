    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        info_btn_save.setOnClickListener{
            if(info_edt_name.text.isNullOrEmpty()){
                ...
                val person = Person(
                    lstPerson[position].id, img,info_edt_name.getText().toString(),
                    info_edt_phone.text.toString().toLong(), info_edt_email.text.toString()
                )
        ...
        info_btn_delete.setOnClickListener{
           val person = Person(lstPerson[position].id,img, info_edt_name.text.toString(),
                info_edt_phone.text.toString().toLong(), info_edt_email.text.toString())
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, imageReturnedIntent: Intent?) {
        ...
        when (requestCode) {
            SELECT_PHOTO -> if (resultCode == Activity.RESULT_OK) {
                ...
                info_iv.setImageBitmap(yourSelectedImage)
            }
        }
